...
const expensesCategories = [
  ...
  { name: 'Games', key: 'entertainment-games', icon: 'GamepadIcon' },
  { name: 'Movies', key: 'entertainment-movies', icon: 'FilmIcon' },
  { name: 'Music', key: 'entertainment-music', icon: 'MusicIcon' },
  { name: 'Sports', key: 'entertainment-sports', icon: 'TennisBallIcon' },
  { name: 'Dining Out', key: 'food-drinks-dining-out', icon: 'RestaurantIcon' },
  { name: 'Groceries', key: 'food-drinks-groceries', icon: 'ShoppingCartIcon' },
